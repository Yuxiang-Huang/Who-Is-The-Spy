...
IL_002b:
	{
		...
		uint8_t L_11;
		L_11 = ChatClient_get_TransportProtocol_m4BB98A08D594DD77AE022FE00D64448DDF01A376(__this, /*hidden argument*/NULL);
	...
	{
		uint8_t L_12;
		L_12 = ChatClient_get_TransportProtocol_m4BB98A08D594DD77AE022FE00D64448DDF01A376(__this, /*hidden argument*/NULL);
...
IL_0094:
	...
	}
	{
		...
		ChatClient_set_TransportProtocol_mACE60C60FECB6C0E4048916E8DB4A727EEFD69DE(__this, 5, /*hidden argument*/NULL);
	}
...
IL_00b4:
	{
		...
		String_t* L_18;
		L_18 = ChatClient_get_NameServerAddress_mFD60FA50656EB21933745288D5DDE67E3CAE8577_inline(__this, /*hidden argument*/NULL);
		String_t* L_19 = __this->get_ProxyServerAddress_7();
		bool L_20;
		L_20 = VirtFuncInvoker5< bool, String_t*, String_t*, String_t*, RuntimeObject *, RuntimeObject * >::Invoke(7 /* System.Boolean ExitGames.Client.Photon.PhotonPeer::Connect(System.String,System.String,System.String,System.Object,System.Object) */, L_17, L_18, L_19, _stringLiteral84F3409D006A485853CE590C6F1C4AA00ABCA26F, NULL, NULL);
		V_0 = L_20;
		// if (isConnecting)
		bool L_21 = V_0;
		V_3 = L_21;
...
IL_00f4:
	{
		...
		bool L_23;
		L_23 = ChatClient_get_UseBackgroundWorkerForSending_m339D1ED46CDD4C32831C1EA88B9A9324F3B1F578_inline(__this, /*hidden argument*/NULL);
		V_4 = L_23;
		bool L_24 = V_4;
		if (!L_24)
		{
	...
	}
	{
		...
		Func_1_t76FCDA5C58178ED310C472967481FDE5F47DCF0F * L_25 = (Func_1_t76FCDA5C58178ED310C472967481FDE5F47DCF0F *)il2cpp_codegen_object_new(Func_1_t76FCDA5C58178ED310C472967481FDE5F47DCF0F_il2cpp_TypeInfo_var);
		Func_1__ctor_m16429CB52E95263F4C11AB13CF51474AFB25D1B9(L_25, __this, (intptr_t)((intptr_t)ChatClient_SendOutgoingInBackground_mDC079C534FBCA7D310F1C7909A4FC84B5675227E_RuntimeMethod_var), /*hidden argument*/Func_1__ctor_m16429CB52E95263F4C11AB13CF51474AFB25D1B9_RuntimeMethod_var);
		int32_t L_26 = __this->get_msDeltaForServiceCalls_24();
		IL2CPP_RUNTIME_CLASS_INIT(SupportClass_tAEC9AA6A7575DBD971F8C4C5E48BB8534DE4069D_il2cpp_TypeInfo_var);
		uint8_t L_27;
		L_27 = SupportClass_StartBackgroundCalls_mE7C9D3F7969DF8A47D46BEEDA675C616AEA45767(L_25, L_26, _stringLiteralDF6A7CB87243568376528ACED2E19B84FDCE6A7C, /*hidden argument*/NULL);
	}
...
IL_0038:
	{
		// if (this.TransportProtocol == ConnectionProtocol.Tcp || this.TransportProtocol == ConnectionProtocol.Udp)
		uint8_t L_5;
		L_5 = ChatClient_get_TransportProtocol_m4BB98A08D594DD77AE022FE00D64448DDF01A376(__this, /*hidden argument*/NULL);
	...
	{
		uint8_t L_6;
		L_6 = ChatClient_get_TransportProtocol_m4BB98A08D594DD77AE022FE00D64448DDF01A376(__this, /*hidden argument*/NULL);
...
IL_006d:
	{
		...
		String_t* L_11 = __this->get_ProxyServerAddress_7();
		bool L_12;
		L_12 = VirtFuncInvoker5< bool, String_t*, String_t*, String_t*, RuntimeObject *, RuntimeObject * >::Invoke(7 /* System.Boolean ExitGames.Client.Photon.PhotonPeer::Connect(System.String,System.String,System.String,System.Object,System.Object) */, L_9, L_10, L_11, _stringLiteral73442709295E0907BAB5FF689567842B1B7D4C01, NULL, NULL);
	...
	}
	{
		...
		RuntimeObject* L_16 = __this->get_listener_18();
		String_t* L_17;
		L_17 = ChatClient_get_FrontendAddress_mD50347BDA6B3C4C2B3D6E6EB2F62E71783F881CA_inline(__this, /*hidden argument*/NULL);
		String_t* L_18;
		L_18 = String_Format_mB3D38E5238C3164DB4D7D29339D9E225A4496D17(_stringLiteralA86D8D1F03036F57943C7BD6C7E29797408CE238, L_17, /*hidden argument*/NULL);
		InterfaceActionInvoker2< uint8_t, String_t* >::Invoke(0 /* System.Void Photon.Chat.IChatClientListener::DebugReturn(ExitGames.Client.Photon.DebugLevel,System.String) */, IChatClientListener_tA617592DD7DA2D048444C95B23037728F8B7A73F_il2cpp_TypeInfo_var, L_16, 1, L_18);
	}
